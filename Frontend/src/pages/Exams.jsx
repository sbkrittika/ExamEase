...
export default function Exams() {
  ...
  const handleSubmit = (e) => {
    ...
    if (!form.course || !form.date || !form.time) {
          ...
          >
            ...
            <div>
              ...
              >
                ...
                <option value="CSE 311: Database Systems">
                  CSE 311: Database Systems
                </option>
                <option value="CSE 312: Web Development">
                  CSE 312: Web Development
                </option>
                <option value="MTH 201: Linear Algebra">
                  MTH 201: Linear Algebra
                </option>
                <option value="PHY 101: Mechanics">
                  PHY 101: Mechanics
                </option>
              </select>
            </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center gap-3 text-sm text-slate-500">
                    ...
                    <span className="flex items-center gap-1.5 bg-slate-100 px-2.5 py-1 rounded-lg">
                      ...
                      <span>
                        {formatTime(exam.time)} ({exam.duration})
                      </span>
                    </span>
