...
const {
    ...
    listRooms, saveRoom, updateRoom, deleteRoom, dashboard, mySchedule, saveFaculty, updateFaculty, deleteFaculty,
...
router.put("/rooms/:id", allowRoles("faculty"), updateRoom);
